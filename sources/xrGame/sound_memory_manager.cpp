...
void CSoundMemoryManager::Load					(pcstr section)
{
}
...
void CSoundMemoryManager::reload				(pcstr section)
{
	...
	pcstr					sound_perceive_section = READ_IF_EXISTS(pSettings,r_string,section,"sound_perceive_section",section);
