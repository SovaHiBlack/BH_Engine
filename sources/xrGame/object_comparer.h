...
struct CComparer
{
	...
	IC	static bool compare(pstr _1, pstr _2, const P& p)
	{
		return						(p(_1, _2));
	}
...
namespace object_comparer
{
	namespace detail
	{
		...
		struct comparer
		{
			...
			IC	bool operator() (pcstr _1, pcstr _2) const
			{
				return(P<s32>( )	(xr_strcmp(_1, _2), 0));
			}
			IC	bool operator() (pstr _1, pstr _2) const
			{
				return(P<s32>( )	(xr_strcmp(_1, _2), 0));
			}
			IC	bool operator() (pcstr _1, pstr _2) const
			{
				return(P<s32>( )	(xr_strcmp(_1, _2), 0));
			}
			IC	bool operator() (pstr _1, pcstr _2) const
			{
				return(P<s32>( )	(xr_strcmp(_1, _2), 0));
			}
		};
