...
const f32	CLOSE_MOVE_DISTANCE = -10.0f;
...
CStalkerActionGetItemToKill::CStalkerActionGetItemToKill(CStalker* object, pcstr action_name) :
...
CStalkerActionMakeItemKilling::CStalkerActionMakeItemKilling(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
...
CStalkerActionRetreatFromEnemy::CStalkerActionRetreatFromEnemy(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
...
CStalkerActionGetReadyToKill::CStalkerActionGetReadyToKill(bool affect_properties, CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{
...
CStalkerActionKillEnemy::CStalkerActionKillEnemy(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
...
CStalkerActionTakeCover::CStalkerActionTakeCover(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
...
CStalkerActionLookOut::CStalkerActionLookOut(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{
...
f32 current_cover(CStalker* object)
{
	fVector3								position, direction;
...
CStalkerActionHoldPosition::CStalkerActionHoldPosition(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
...
CStalkerActionDetourEnemy::CStalkerActionDetourEnemy(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
...
CStalkerActionSearchEnemy::CStalkerActionSearchEnemy(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
...
CStalkerActionPostCombatWait::CStalkerActionPostCombatWait(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
...
CStalkerActionGetDistance::CStalkerActionGetDistance(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
...
CStalkerActionHideFromGrenade::CStalkerActionHideFromGrenade(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
...
CStalkerActionSuddenAttack::CStalkerActionSuddenAttack(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
...
CStalkerActionKillEnemyIfPlayerOnThePath::CStalkerActionKillEnemyIfPlayerOnThePath(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
...
CStalkerActionCriticalHit::CStalkerActionCriticalHit(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
