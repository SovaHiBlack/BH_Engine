...
void CSoundPlayer::reload			(pcstr section)
{
...
u32 CSoundPlayer::add				(pcstr prefix, u32 max_count, ESoundTypes type, u32 priority, u32 mask, u32 internal_type, pcstr bone_name, CSound_UserDataPtr data)
{
...
void CSoundPlayer::update			(f32 time_delta)
{
...
IC	fVector3 CSoundPlayer::compute_sound_point(const CSoundSingle &sound)
{
