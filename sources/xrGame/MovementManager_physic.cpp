////////////////////////////////////////////////////////////////////////////
//	Module 		: MovementManager_physic.cpp
//	Created 	: 03.12.2003
//  Modified 	: 03.12.2003
...
#define DISTANCE_PHISICS_ENABLE_CHARACTERS 2.0f
...
fis_zero(old_desirable_speed( ))
)
	{
		...
		{
			movement_control->SetPosition(dest_position); movement_control->DisableCharacter( );
		})
			if (movement_control->IsCharacterEnabled( ))
			{
...
//	VERIFY(movement_control->CharacterExist());
	...
	f32				desirable_speed = old_desirable_speed( );				// желаема€ скорость объекта
	f32				dist = desirable_speed * time_delta;		// пройденное рассто€ние в соостветствие с желаемой скоростью 
