...
CStalkerActionDangerGrenadeTakeCover::CStalkerActionDangerGrenadeTakeCover(CStalker* object, pcstr action_name) :
...
CStalkerActionDangerGrenadeWaitForExplosion::CStalkerActionDangerGrenadeWaitForExplosion(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
...
CStalkerActionDangerGrenadeTakeCoverAfterExplosion::CStalkerActionDangerGrenadeTakeCoverAfterExplosion(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
...
CStalkerActionDangerGrenadeLookAround::CStalkerActionDangerGrenadeLookAround(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
...
CStalkerActionDangerGrenadeSearch::CStalkerActionDangerGrenadeSearch(CStalker* object, pcstr action_name) :
	inherited(object, action_name)
{ }
