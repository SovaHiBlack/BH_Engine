...
void CObjectList::Update(bool bForce)
{
	...
	{
		// Clients
		if (Device.fTimeDelta > EPSILON_7 || bForce)
		{
			// Select Crow-Mode
	...
	if (!destroy_queue.empty( ))
	{
		...
		{
			for (s32 it = destroy_queue.size( ) - 1; it >= 0; it--)
			{
...
void CObjectList::relcase_register(RELCASE_CALLBACK cb, s32* ID)
{
...
void CObjectList::relcase_unregister(s32* ID)
{
