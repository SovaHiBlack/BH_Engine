...
//		.def("armor",						&CScriptGameObject::Armor)
		...
		.def("play_cycle",					(void (CScriptGameObject::*)(pcstr))(&CScriptGameObject::play_cycle))
		.def("play_cycle",					(void (CScriptGameObject::*)(pcstr,bool))(&CScriptGameObject::play_cycle))
...
//		.def("best_sound",					&CScriptGameObject::GetBestSound)
		...
		//.def("set_hear_callback",			(void (CScriptGameObject::*)(const luabind::object &, pcstr))(&CScriptGameObject::SetSoundCallback))
		...
		.def("add_animation",				(void (CScriptGameObject::*)(pcstr, bool, bool))(&CScriptGameObject::add_animation))
		...
		.def("extrapolate_length",			(f32(CScriptGameObject::*)() const)(&CScriptGameObject::extrapolate_length))
		.def("extrapolate_length",			(void (CScriptGameObject::*)(f32))(&CScriptGameObject::extrapolate_length))
