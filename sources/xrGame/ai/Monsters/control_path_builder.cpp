...
void CControlPathBuilder::load(pcstr section)
{
}
...
u32	 CControlPathBuilder::find_nearest_vertex(const u32& level_vertex_id, const fVector3& target_position, const f32& range)
{
	xr_vector<u32>	temp;
